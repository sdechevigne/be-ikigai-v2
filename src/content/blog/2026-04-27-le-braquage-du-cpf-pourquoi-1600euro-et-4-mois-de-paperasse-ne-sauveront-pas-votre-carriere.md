...
summary:
  - Le bilan de compétences CPF est plafonné à 1600€ et impose un reste à charge
    de 150€ depuis 2026.
  - "On vous fait patienter jusqu’à 4 mois pour valider ce que vous ressentez
    déjà : vous n’êtes plus à votre place."
  - Changer de métier sans changer de logiciel interne, c’est déplacer le
    problème, pas le résoudre.
  - Votre architecture intérieure se moque de vos diplômes et des listes de
    métiers qui recrutent.
  - Be-Ikigai propose un diagnostic de destinée en 48 heures au lieu de 4 mois
    de rendez-vous espacés.
  - Pour 580€, vous repartez avec un plan de bataille concret ou vous êtes
...
`{`  
  ...
  `"mainEntity": [`  
    `{`  
      `"@type": "Question",`  
      `"name": "Qu’est-ce qui a changé pour le bilan de compétences CPF en 2026 ?",`  
      `"acceptedAnswer": {`  
        `"@type": "Answer",`  
        `"text": "En 2026, le financement CPF d’un bilan de compétences est plafonné à 1600€, avec une durée minimale de 13 heures et un délai de 5 ans entre deux bilans financés sur fonds publics."`  
      `}`  
    `},`  
    `{`  
      `"@type": "Question",`  
      `"name": "Le reste à charge de 150€ est-il obligatoire pour tout le monde ?",`  
      `"acceptedAnswer": {`  
        `"@type": "Answer",`  
        `"text": "Le reste à charge de 150€ s’applique à la plupart des utilisateurs du CPF à partir du 2 avril 2026, sauf publics exonérés comme certains demandeurs d’emploi ou salariés avec abondement spécifique."`  
      `}`  
    `},`  
    `{`  
      `"@type": "Question",`  
      `"name": "Un bilan de compétences CPF dure vraiment 4 mois ?",`  
      `"acceptedAnswer": {`  
        `"@type": "Answer",`  
        `"text": "La durée totale est comprise entre 13 et 24 heures, généralement réparties sur 2 à 4 mois, ce qui allonge le temps avant d’obtenir un plan concret."`  
      `}`  
    `},`  
    `{`  
      `"@type": "Question",`  
      `"name": "Est-ce risqué de ne pas passer par un bilan CPF classique ?",`  
      `"acceptedAnswer": {`  
        `"@type": "Answer",`  
        `"text": "Le vrai risque est de rester bloqué des années dans une situation qui ne vous convient plus. Un accompagnement hors CPF permet souvent d’aller plus vite et plus profond."`  
      `}`  
    `},`  
    `{`  
      `"@type": "Question",`  
      `"name": "En quoi le diagnostic Be-Ikigai est différent d’un bilan de compétences ?",`  
      `"acceptedAnswer": {`  
        `"@type": "Answer",`  
        `"text": "Be-Ikigai part de votre architecture interne et de vos codes de naissance plutôt que de votre seul parcours. En 48 heures, vous repartez avec un plan de bataille concret, ou vous êtes remboursé."`  
      `}`  
    `}`  
  `]`  
`}`