...
lang: fr
description: "Tu as un bon job, un bon salaire, mais un vide intérieur ? Tu n'es pas seul. Découvre ce qu'est la souffrance douce et comment en sortir."
seoKeywords: souffrance douce au travail, brown-out, perte de sens, ikigai, reconversion
summary:
  - "La souffrance douce ou « brown-out » est ce vide que tu ressens au travail, même quand tout semble parfait en surface."
  - "Ce n'est pas un burn-out violent. C'est une anesthésie professionnelle qui s'installe quand tes missions heurtent tes valeurs."
  - "Ton cas n'est pas isolé : seuls 7 % des salariés français sont engagés dans leur travail (Gallup, 2023)."
  - "Pour sortir de la cage dorée (bon salaire, statut), il faut d'abord poser un diagnostic clair sur ce qui ne va plus."
social_summary:
  - "Bon job, bon salaire, mais un vide intérieur ? Tu n'es pas seul. C'est la « souffrance douce ». #Reconversion"
  - "Ce n'est pas le burn-out, c'est le brown-out : une perte de sens quand ton job heurte tes valeurs. #SensAuTravail"
  - "La statistique qui fait mal : 7 % des salariés français se sentent vraiment engagés dans leur travail. (Gallup, 2023) #Ikigai"
  - "Le piège ? La « cage dorée ». Un bon salaire et un statut qui t'empêchent de bouger. #Carrière"
  - "Avant de tout plaquer, la première étape est de comprendre pourquoi tu en es là. #BeIkigai"
schemaOrg:
  - >
    {
      "@context": "https://schema.org",
      "@type": "BlogPosting",
      "headline": "Souffrance douce au travail : le burn-out silencieux des bons élèves",
      "description": "Tu as un bon job, un bon salaire, mais un vide intérieur ? Tu n'es pas seul. Découvre ce qu'est la souffrance douce et comment en sortir.",
      "author": {
        "@type": "Person",
        "name": "Pierre-Louis"
...
faq:
  ...
  - question: "Quels sont les chiffres du désengagement en France ?"
    answer: "D'après Gallup (2023), seuls 7 % des salariés français sont engagés dans leur travail, contre 13 % en moyenne en Europe."
  - question: "Quelle différence entre burn-out et brown-out ?"
    answer: "Le burn-out, c'est l'épuisement par la surcharge (le 'trop-plein'). Le brown-out, c'est l'extinction par manque de sens (le 'trop vide')."
  - question: "Pourquoi les 25-40 ans sont-ils si touchés ?"
    answer: "Cette génération veut un impact que les structures rigides des entreprises peinent à offrir. La frustration est inévitable."
  - question: "Est-ce que je suis juste un enfant gâté de me plaindre ?"
    answer: "Non. Vouloir du sens est légitime. La culpabilité est un symptôme du problème, pas la preuve que ton ressenti est faux."
---
