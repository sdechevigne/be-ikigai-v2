...
description: Tu as un bon job, un bon salaire, mais un vide intérieur ? Tu n'es
  pas seul. Découvre ce qu'est la souffrance douce et comment en sortir.
seoKeywords: souffrance douce au travail, brown-out, perte de sens, ikigai, reconversion
summary:
  - La souffrance douce ou « brown-out » est ce vide que tu ressens au travail,
    même quand tout semble parfait en surface.
  - Ce n'est pas un burn-out violent. C'est une anesthésie professionnelle qui
    s'installe quand tes missions heurtent tes valeurs.
  - "Ton cas n'est pas isolé : seuls 7 % des salariés français sont engagés dans
    leur travail (Gallup, 2023)."
  - Pour sortir de la cage dorée (bon salaire, statut), il faut d'abord poser un
    diagnostic clair sur ce qui ne va plus.
...
faq:
  - question: C'est quoi la souffrance douce au travail ?
    answer: C'est un décalage permanent entre tes valeurs et tes missions. Pas une
      explosion comme le burn-out, mais une perte de sens qui s'installe.
  - question: Quels sont les chiffres du désengagement en France ?
    answer: D'après Gallup (2023), seuls 7 % des salariés français sont engagés dans
      leur travail, contre 13 % en moyenne en Europe.
  - question: Quelle différence entre burn-out et brown-out ?
    answer: Le burn-out, c'est l'épuisement par la surcharge (le 'trop-plein'). Le
      brown-out, c'est l'extinction par manque de sens (le 'trop vide').
  - question: Pourquoi les 25-40 ans sont-ils si touchés ?
    answer: Cette génération veut un impact que les structures rigides des
      entreprises peinent à offrir. La frustration est inévitable.
